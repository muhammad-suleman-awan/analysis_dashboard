...
const Drawer = () => {
  ...
  return (
    <div
      ...
      id="side-manu"
      className="hidden sm:block sm:flex  space-between  flex-col mx-2 w-10 gird-cols-1" >
      <div className="font-medium scrollpr overflow-y-auto overflow-x-hidden  basis-11/12">
        <ul>
          <li>
            <button
              type="button"
              className="flex items-center w-52 p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            ...
            <ul id="dropdown-example" className="hidden  py-2 space-y-2">
              <li>
                <a
                  href="#"
                  className="flex items-center w-52 p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                >
                  Analysis
                </a>
              </li>
      ...
      <div className="basis-1/12 flex mb-5 lg:mb-0">
        <button
          className=" justify-items-end	 pl-2"
          type="button"
          onClick={() => {
            ...
            if (manu.classList.contains("w-10")) {
              manu.classList =
                manu.classList +
                " transition-all		  duration-300 w-50 delay-10  ";
              ...
              manu.classList =
                manu.classList +
                "transition-transform	  duration-2800 w-10 delay-150";
              manu.classList.remove("w-50");
            }
          }}
        >
          <span
