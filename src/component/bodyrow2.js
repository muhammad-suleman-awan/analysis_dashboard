  ...
  return (
    <div className="px-5 py-5 grid grid-col-3  col-lg-4 ">
      <div className=" grid grid-cols-6 md:grid-cols-12 ">
        <div
          className="col-span-8 2xl:col-span-2 xl:col-span-2 lg:col-span-3 
        md:col-span-4 pl-5 space-x-0 lg:space-x-5   py-1"
        >
          <button
            type="button"
            class=" px-5 mr-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg  
            hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700
          ...
          <button
            type="button"
            class="px-5 mr-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg   hover:bg-gray-100
             hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 
